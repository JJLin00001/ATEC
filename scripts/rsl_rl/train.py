...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    if hasattr(args_cli, "resume_path") and args_cli.resume_path is not None:
    ...
    # load the checkpoint
    if (hasattr(args_cli, "resume_path") and args_cli.resume_path is not None) or agent_cfg.resume or agent_cfg.algorithm.class_name == "Distillation":
